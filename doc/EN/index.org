...
With the right technology the internet can be a space for free expression, exploration, cooperation and fun. It doesn't have to be a surveillance prison owned and run by an diabolical synthesis of megacorporations and governments. Freedombone is designed to help you escape from the walled gardens and the people-farming business models.  It's a self-hosted home server configuration which can be installed onto any computer capable of running Debian, so if you have an old laptop or netbook which you can leave turned on then you can use Freedombone to provide your own internet services, such as blogging, wiki, email, chat and social networking and have independence from the well known internet companies.
